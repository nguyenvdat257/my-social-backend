...
def get_stories_current_user(request):
    ...
    self_stories = StorySerializer(self_stories, many=True, context={'current_profile': profile}).data
    following_stories = StorySerializer(following_stories, many=True, context={'current_profile': profile}).data
    response_following = {}
    ...
    return Response({'self_stories': self_stories, 'following_stories': response_following.items()})
