...
urlpatterns = [
    ...
    path('posts/<str:code>', views.process_post, name="process-post"),
    ...
    path('posts/by-tag-popular/<str:tag>', views.get_posts_by_tag_popular, name="get-posts-by-tag-popular"),
    path('posts/by-tag-recent/<str:tag>/', views.get_posts_by_tag_recent, name="get-posts-by-tag-recent"),
    ...
    path('posts/like-profile/<str:post_code>', views.get_post_like_profile, name="post-like-profile"),
    ...
    path('comments/<int:pk>', views.delete_comment, name="process-post"),
    path('comments/<str:post_code>', views.get_comments, name="get-comments"),
    ...
    path('follows/follower', views.get_follower, name="get-follower"),
    path('follows/following', views.get_following, name="get-following"),
    path('token/', MyTokenObtainPairView.as_view(), name='token_obtain_pair'),
    path('token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    path('signup/', views.user_signup, name='token_refresh'),
